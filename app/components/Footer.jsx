            ...
            <div className="flex flex-wrap -mx-4">
               <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-6/12 xl:w-6/12">
                  <div className="w-full mb-10">
                     <a href="/" className="mb-6 inline-block max-w-[160px]">
                        <img src="/images/logo/logo-white.png" alt="logo" className="max-w-full" />
                     </a>
               ...
               <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                  <div className="w-full mb-10">
                     ...
                     <ul>
                        <li>
                           <a href="#features" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              Features
                           </a>
                        </li>
                        <li>
                           <a href="#pricing" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              Pricing
                           </a>
                        </li>
                        <li>
                           <a href="#faq" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              FAQ
                           </a>
                        </li>
                     </ul>
               ...
               <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                  <div className="w-full mb-10">
                     ...
                     <ul>
                        <li>
                           <a href="/" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              Dashboard Analitik
                           </a>
                        </li>
                        <li>
                  ...
                  <div className="w-full px-4 md:w-1/3 lg:w-1/2">
                     <div className="flex justify-center my-1 md:justify-end">
                        <p className="text-base text-gray-7">
                           Dibuat dengan
                           <a href="/" rel="nofollow noopner" target="_blank" className="text-gray-1 hover:underline">
                              ❤️
                           </a>
