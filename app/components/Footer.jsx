            ...
            <div className="flex flex-wrap -mx-4">
               ...
               <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                  <div className="w-full mb-10">
                     ...
                     <ul>
                        <li>
                           <a href="javascript:void(0)" className="inline-block mb-3 text-base text-gray-7 hover:text-primary">
                              Home
                           </a>
                        </li>
                        <li>
                  ...
                  <div className="w-full px-4 md:w-1/3 lg:w-1/2">
                     <div className="flex justify-center my-1 md:justify-end">
                        <p className="text-base text-gray-7">
                           ...
                           <a href="https://tailgrids.com" rel="nofollow noopner" target="_blank" className="text-gray-1 hover:underline">
