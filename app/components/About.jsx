               ...
               <div className="flex flex-wrap items-center -mx-4">
                  <div className="w-full px-4 lg:w-1/2">
                     <div className="mb-12 max-w-[540px] lg:mb-0">
                        <h2 className="mb-5 text-3xl font-bold leading-tight text-dark dark:text-white sm:text-[40px] sm:leading-[1.2]">Satu Alat, Banyak Manfaat</h2>
                        <p className="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                        Dengan Sakuin, UMKM tidak perlu lagi repot mengatur laporan manual. Semua transaksi tercatat otomatis, analitik bisa dilihat real-time, dan AI siap memberikan rekomendasi cerdas kapan pun dibutuhkan.
                        </p>

                        <a href="/" className="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border rounded-md border-primary bg-primary px-7 hover:border-blue-dark hover:bg-blue-dark">
                           Coba Sekarang
                        </a>
                     </div>
                  </div>
                     ...
                     <div className="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                        <div className="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                           <div className="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]">
                              <img src="/images/about/about-image-01.jpg" alt="about image" className="object-cover object-center w-full h-full" />
                           </div>
                        </div>
