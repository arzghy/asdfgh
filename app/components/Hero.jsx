               ...
               <div className="w-full px-4">
                  <div className="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                     ...
                     <div>
                        ...
                        <div className="flex items-center justify-center gap-4 text-center wow fadeInUp" data-wow-delay=".3s">
                           <a href="https://github.com/uideck/play-bootstrap/" className="duration-300 ease-in-out text-white/60 hover:text-white" target="_blank">
                              <svg className="fill-current" width="41" height="32" viewBox="0 0 41 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <mask id="mask0_2005_10788" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="0" y="0" width="41" height="32">
                           ...
                           <a href="https://github.com/TailGrids/play-tailwind/" className="duration-300 ease-in-out text-white/60 hover:text-white" target="_blank">
                              <svg className="fill-current" width="41" height="26" viewBox="0 0 41 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <mask id="mask0_2005_10783" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="0" y="0" width="41" height="26">
                           ...
                           <a href="https://github.com/NextJSTemplates/play-nextjs" className="duration-300 ease-in-out text-white/60 hover:text-white" target="_blank">
                              <svg className="fill-current" width="41" height="36" viewBox="0 0 41 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <a href="https://github.com/TailGrids/play-astro/" className="duration-300 ease-in-out text-white/60 hover:text-white" target="_blank">
                              <svg className="mt-0.5 fill-current" width="30" height="38" viewBox="0 0 30 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <a href="https://github.com/NextJSTemplates/play-nextjs" className="duration-300 ease-in-out text-white/60 hover:text-white" target="_blank">
                              <svg className="fill-current" width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
