               ...
               <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
                  <div className="px-5 pt-12 pb-10 mb-8 bg-white group rounded-xl shadow-testimonial dark:bg-dark dark:shadow-none">
                     <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                        <img src="/images/team/team-01.png" alt="team image" className="h-[120px] w-[120px] rounded-full" />
                     </div>
                     <div className="text-center">
                        <h4 className="mb-1 text-lg font-semibold text-dark dark:text-white">Faza Izzaturrafi</h4>
                        <p className="mb-5 text-sm text-body-color dark:text-dark-6">Front-end Developer</p>
                     </div>
                  </div>
               </div>
               <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
                  <div className="px-5 pt-12 pb-10 mb-8 bg-white group rounded-xl shadow-testimonial dark:bg-dark dark:shadow-none">
                     ...
                     <div className="text-center">
                        ...
                        <p className="mb-5 text-sm text-body-color dark:text-dark-6">Project Manager</p>
                     </div>
                  </div>
               </div>
               <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
                  <div className="px-5 pt-12 pb-10 mb-8 bg-white group rounded-xl shadow-testimonial dark:bg-dark dark:shadow-none">
                     ...
                     <div className="text-center">
                        ...
                        <p className="mb-5 text-sm text-body-color dark:text-dark-6">Back-end Developer</p>
                     </div>
                  </div>
               </div>
               {/* ... Other Team Members ... */}
