      ...
      <footer className="wow fadeInUp relative z-10 bg-primary pt-20 lg:pt-[100px]" data-wow-delay=".15s">
         <div className="container px-4 mx-auto">
            <div className="flex flex-wrap -mx-4">
               <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-6/12 xl:w-6/12">
                  <div className="w-full mb-10">
                     <Link href="/" className="mb-6 inline-block max-w-[160px]">
                        <Image src="/images/logo/logo-white.png" alt="logo" className="max-w-full" width={0} height={0} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                     </Link>
                     <p className="mb-8 max-w-[270px] text-base text-gray-7">Kelola cashflow bisnis UMKM lebih mudah dengan pencatatan otomatis, analitik real-time, dan rekomendasi AI.</p>
               ...
               <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                  <div className="w-full mb-10">
                     <h4 className="text-lg font-semibold text-white mb-9">About Product</h4>
                     <ul>
                        <li>
                           <Link href="#features" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              Features
                           </Link>
                        </li>
                        <li>
                           <Link href="#pricing" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              Pricing
                           </Link>
                        </li>
                        <li>
                           <Link href="#faq" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              FAQ
                           </Link>
                        </li>
                     </ul>
               ...
               <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                  <div className="w-full mb-10">
                     <h4 className="text-lg font-semibold text-white mb-9">Our Solution</h4>
                     <ul>
                        <li>
                           <Link href="/" className="inline-block mb-3 text-base text-gray-7 hover:text-white">
                              Dashboard Analitik
                           </Link>
                        </li>
                        <li>
                  ...
                  <div className="w-full px-4 md:w-2/3 lg:w-1/2">
                     <div className="my-1">
                        <div className="flex items-center justify-center -mx-3 md:justify-start">
                           <p className="px-3 text-base text-gray-7 hover:text-white hover:underline">© 2025 Sakuin. All Rights Reserved.</p>
                        </div>
                     </div>
                  </div>
                  <div className="w-full px-4 md:w-1/3 lg:w-1/2">
                     <div className="flex justify-center my-1 md:justify-end">
                        <p className="text-base text-gray-7">
                           Dibuat dengan
                           <Link href="/" rel="nofollow noopner" target="_blank" className="text-gray-1 hover:underline">
                              ❤️
                           </Link>
                           untuk mendukung UMKM Indonesia.
                        </p>
                     </div>
                  </div>
               </div>
         ...
         <div>
            <span className="absolute left-0 top-0 z-[-1]">
               <Image src="/images/footer/shape-1.svg" alt="" width={0} height={0} sizes="100vw" style={{ width: "100%", height: "auto" }} />
            </span>

            <span className="absolute bottom-0 right-0 z-[-1]">
               <Image src="/images/footer/shape-3.svg" alt="" width={0} height={0} sizes="100vw" style={{ width: "100%", height: "auto" }} />
            </span>
