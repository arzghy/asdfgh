            ...
            <div className="flex flex-wrap items-center -mx-4">
               <div className="w-full px-4">
                  <div className="text-center">
                     <h1 className="mb-4 text-3xl font-bold text-white sm:text-4xl md:text-[40px] md:leading-[1.2]">Blog Grid</h1>
                     <p className="mb-5 text-base text-white">There are many variations of passages of Lorem Ipsum available.</p>
                     ...
                     <ul className="flex items-center justify-center gap-[10px]">
                        ...
                        <li>
                           <Link href="/blog" className="flex items-center gap-[10px] text-base font-medium text-white">
