          ...
          <div>
            <label htmlFor="checkboxLabelOne" className="flex items-start text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
              <div className="relative">
                ...
                />
                <div className={`mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] ${agreed ? 'border-brand-500 bg-brand-700' : 'bg-transparent border-gray-300 dark:border-gray-700'}`}>
